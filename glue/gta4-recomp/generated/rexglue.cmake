...
# Find SDK
# Default fallback: LibertyRecomp ships the SDK sources in glue/rexglue-sdk-main.
set(REXSDK_DIR "${CMAKE_SOURCE_DIR}/glue/rexglue-sdk-main" CACHE PATH "Path to rexglue-sdk source tree")
if(REXSDK_DIR AND EXISTS "${REXSDK_DIR}/CMakeLists.txt")
    ...
    if(REXSDK_VERSION)
        ...
        find_package(rexglue 0.7.5 QUIET CONFIG)
    endif()
